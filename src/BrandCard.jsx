...
const BrandCard = ({ name, logo, id }) => {
    ...
    return (
        <Card onClick={() => { navigate(`/company/${id}`) }} renderImage={() => <div className='flex justify-center h-full'><img src={logo} className='w-28 object-contain' /></div>} className='p-1 m-1 w-60'>
